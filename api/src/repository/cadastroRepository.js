...
export async function cadastro(pedido){
    ...
    const resposta = await con.query(comando, [pedido.telefone, pedido.cliente,pedido.rua,pedido.bairro,pedido.complemento,pedido.nr,pedido.hamburgueres,pedido.bebidas,pedido.porcoes,pedido.sobremesas,pedido.total]);
